...
public class PersonService {
    ...
    /**
     * Save a new person if it doesn't exist into the personsList
     * @param person the person object to save
     * @return true if succeeded, false otherwise
     */
    public boolean save(Person person) {
        if (this.findPersonByFirstnameLastname(person.getFirstName(), person.getLastName()) == null) {
    ...
    /**
     * Update a person based on the given FirstName/LastName arguments
     * @param firstname
     * @param lastname
     * @param phone
     * @param zip
    ...
    /**
     * Delete a Person in the inner list based on the given firstName LastName
     * @param firstname
     * @param lastname
     * @return true if succeeded, false otherwise
     */
    ...
    /**
     * Save a Person's medical record based on the given firstname/lastname
     * @param firstname
     * @param lastname
     * @param medication
     * @param allergie
    ...
    /**
     * Update a Person's medical record based on the given firstname/lastname
     * @param firstname
     * @param lastname
     * @param medication
     * @param allergie
    ...
    /**
     * delete a Person's medical record based on the given firstname/lastname
     * @param firstname
     * @param lastname
     * @return
     */
    ...
    /**
     * return a Person object from the inner list based on the given firstname / lastname
     * @param firstname
     * @param lastname
     * @return the Person object corresponding or null
     */
    public Person findPersonByFirstnameLastname(String firstname, String lastname) {
        ...
        for (Person person : personsList) {
            if (Objects.equals(person.getFirstName(), firstname) && Objects.equals(person.getLastName(), lastname)) {
                personResult = person;
                logger.info(firstname + " " + lastname + " found");
                break;
            }
        }
        if (personResult == null) {
